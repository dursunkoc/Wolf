...
public class Environment {
	...
	public Environment(Map<String, Variable> env) {
		this.env = env;
	}
	...
	public void UpdateVariable(String name, Variable variable) throws VariableDoesNotExistException {
		if (!isVariableExists(name)) {
	...
	private void assertVariableDoesNotExist(String name) throws VariableDoesNotExistException {
