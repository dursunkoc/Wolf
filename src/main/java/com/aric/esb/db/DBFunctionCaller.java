 ...
 * 
 */
public class DBFunctionCaller extends DBCaller {
	private String id;
	 ...
	 */
	public DBFunctionCaller(String dbMethodName, ReturnMap returnMap,
	...
	protected void bindArguments(ArgumentBundle argumentBundle,
		...
		for (int i = 0; i < argumentBundle.size(); i++) {
			callStmt.setObject(i + 2, argumentBundle.marshallArguments()[i]);
		}
	}
